...
//    }
     ...
     */
    protected abstract Bitmap processBitmap(Object data,String params);
    ...
    private class BitmapWorkerTask extends AsyncTask<Void, Void, BitmapDrawable> {
        ...
        public BitmapWorkerTask(Object data,String params, ImageView imageView) {
            mData = data;
            mParams = params;
        ...
        protected BitmapDrawable doInBackground(Void... params) {
            ...
            if (mImageCache != null && !isCancelled() && getAttachedImageView() != null
                    && !mExitTasksEarly) {
                bitmap = mImageCache.getBitmapFromDiskCache(dataString+mParams);
            }
            ...
            if (bitmap == null && !isCancelled() && getAttachedImageView() != null
                    && !mExitTasksEarly) {
                bitmap = processBitmap(mData,mParams);
            }
            ...
            if (bitmap != null) {
                ...
                if (mImageCache != null) {
                    mImageCache.addBitmapToCache(dataString+mParams, drawable);
                }
            }
