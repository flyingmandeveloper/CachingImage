...
package com.flyingmain.CachingImage.util;
...
import com.flyingman.cachingimage.BuildConfig;
...
public class ImageCache {
     ...
     */
    public static ImageCache getInstance(
            android.support.v4.app.FragmentManager fragmentManager, ImageCacheParams cacheParams) {

        // Search for, or create an instance of the non-UI RetainFragment
        final RetainFragment_v4 mRetainFragment = findOrCreateRetainFragment(fragmentManager);
    ...
    public static class ImageCacheParams {
        ...
        public void setMemCacheSizePercent(float percent) {
            ...
            Log.e("debug", "setMemCacheSizePercent("+percent+")");
            ...
            Log.e("debug", "memCacheSize("+memCacheSize+")");
        }
    }
    ...
    private static RetainFragment_v4 findOrCreateRetainFragment(android.support.v4.app.FragmentManager fm) {
        //BEGIN_INCLUDE(find_create_retain_fragment)
        // Check to see if we have retained the worker fragment.
        RetainFragment_v4 mRetainFragment = (RetainFragment_v4) fm.findFragmentByTag(TAG);

        // If not retained (or first time running), we need to create and add it.
        if (mRetainFragment == null) {
            mRetainFragment = new RetainFragment_v4();
            fm.beginTransaction().add(mRetainFragment, TAG).commitAllowingStateLoss();
        }
    ...
    public static class RetainFragment_v4 extends android.support.v4.app.Fragment {
        private Object mObject;

        /**
         * Empty constructor as per the Fragment documentation
         */
        public RetainFragment_v4() {}
